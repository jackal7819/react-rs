		...
		<div className='grid px-8 antialiased min-h-page md:pb-20 bg-slate-200 dark:text-slate-400 dark:bg-slate-900 text-slate-700 place-items-center'>
			<div className='max-w-4xl p-4 mx-auto'>
				...
				<p className='mb-4 text-lg'>
					Hello! I&apos;m a beginner frontend developer currently studying React on the RS
					School course. I love programming and enjoy learning new technologies to build
					awesome web applications.
				</p>
				<p className='mb-4 text-lg'>
					This application was created as part of my learning journey. It uses the Rick
					and Morty API to display fun and interesting content.
				</p>
